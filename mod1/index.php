...
class tx_rss2import_module1 extends t3lib_SCbase
{
	 ...
	 */
            ...
            $headerSection = $this->doc->getHeader("pages", $this->pageinfo,
                    $this->pageinfo["_thePath"]) . "<br>" . $LANG->sL("LLL:EXT:lang/locallang_core.php:labels.path") . ": " . t3lib_div::fixed_lgd_cs($this->pageinfo["_thePath"],
                    50);
    ...
    private function getAvailableFeeds()
    {
                    ...
                    <thead>
                        <tr class="t3-row-header">
                            <th class="t3-col-header t3-cell">
                                ...
                                ' . $LANG->getLL("feeds.edit") . '
                                </div>
                            </th>
                            <th class="t3-col-header">
                                <div class="t3-cell-inner">
                                ' . $LANG->getLL("feeds.title") . '
                                </div>
                            </th>
                            <th class="t3-col-header">
                                <div class="t3-cell-inner">
                                ' . $LANG->getLL("feeds.url") . '
                                </div>
                            </th>
                            <th class="t3-col-header">
                                <div class="t3-cell-inner">
                                ' . $LANG->getLL("feeds.update") . '
                                </div>
                            </th>
                        </tr>
                    </thead>
        ...
        foreach ($feeds as $feed) {
            ...
            $editIcon = '<img' . t3lib_iconWorks::skinImg($this->doc->backPath, 'gfx/edit2.gif',
                    '') . ' title="' . $GLOBALS['LANG']->getLL('editrecord') . '" border="0" alt="" style="vertical-align:middle;" />';
            $editLink = '<a style="text-decoration: none;" href="#" onclick="' . htmlspecialchars(t3lib_BEfunc::editOnClick('&edit[tx_rss2import_feeds][' . $feed['uid'] . ']=edit',
        ...
        $newLink = '<a style="text-decoration: none;" href="#" onclick="' . htmlspecialchars(t3lib_BEfunc::editOnClick('&edit[tx_rss2import_feeds][' . $this->page_for_feeds . ']=new',
